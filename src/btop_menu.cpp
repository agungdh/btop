	...
	const vector<vector<vector<string>>> categories = {
		{
			...
			{"http",
				"HTTP server mode.",
				"",
				"Listen address for the headless HTTP",
				"server, e.g. \"127.0.0.1:8080\".",
				"",
				"The value may be \"host:port\", \":port\"",
				"or just \"port\". Empty string disables",
				"the server. Port 0 picks a free port."},
			{"http_auth",
				"HTTP basic auth.",
				"",
				"Require HTTP basic auth on all HTTP",
				"server endpoints, in the form",
				"\"user:password\".",
				"",
				"Only used together with \"http\"."}
		},
		{
			{"cpu_bottom",
				"Cpu box location.",
