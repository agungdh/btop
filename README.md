...
This fork (v0.0.3) is based on upstream [btop](https://github.com/aristocratos/btop) v1.4.7 and adds a headless [JSON output mode](#json-output-mode) so btop can be used from scripts, cron jobs or as a monitoring daemon without a terminal.
